  ...
  return (
    <div className={
      ...
      <div className='hidden lg:flex h-full self-end'>
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 100 100" fill="none" class="decor-tesseract">
          <g stroke="#7467FF" stroke-linejoin="round">
            <polygon points="15,15 85,15 85,85 15,85" stroke-width="2" />
            <polygon points="35,35 65,35 65,65 35,65" stroke-width="1.5" />
            <polygon points="43,43 57,43 57,57 43,57" stroke-width="1" opacity="0.6" />
            <line x1="15" y1="15" x2="35" y2="35" stroke-width="1.5" />
            <line x1="85" y1="15" x2="65" y2="35" stroke-width="1.5" />
            <line x1="85" y1="85" x2="65" y2="65" stroke-width="1.5" />
            <line x1="15" y1="85" x2="35" y2="65" stroke-width="1.5" />
            <line x1="50" y1="15" x2="50" y2="35" stroke-dasharray="2 4" stroke-width="1.5" opacity="0.7" />
            <line x1="50" y1="85" x2="50" y2="65" stroke-dasharray="2 4" stroke-width="1.5" opacity="0.7" />
            <line x1="15" y1="50" x2="35" y2="50" stroke-dasharray="2 4" stroke-width="1.5" opacity="0.7" />
            <line x1="85" y1="50" x2="65" y2="50" stroke-dasharray="2 4" stroke-width="1.5" opacity="0.7" />
